...
void visionScene2::update(){
    ...
    myFbo.begin();
        ...
        ofPushView();
            ...
            myVideoGrabber.draw(325,0);
            myVideoGrabber.draw(650,0);
            myVideoGrabber.draw(975,0);
    
            myVideoGrabber.draw(0,245);
            myVideoGrabber.draw(325,245);
            myVideoGrabber.draw(650,245);
            myVideoGrabber.draw(975,245);
    
            myVideoGrabber.draw(0,490);
            myVideoGrabber.draw(325,490);
            myVideoGrabber.draw(650,490);
            myVideoGrabber.draw(975,490);
    
            myVideoGrabber.draw(0,735);
            myVideoGrabber.draw(325,735);
            myVideoGrabber.draw(650,735);
            myVideoGrabber.draw(975,735);
...
//--------------------------------------------------------------
void visionScene2::keyPressed(int key){
...
//--------------------------------------------------------------
void visionScene2::keyReleased(int key){
